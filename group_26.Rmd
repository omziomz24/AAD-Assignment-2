...
\begin{itemize}*{How we used the data:}
  \item The KNN regression model was trained using the encoded and preprocessed training data (`train_data_encoded`), which includes both numeric and one-hot encoded categorical variables.
